...
public final class MyStandardAnalyzer extends StopwordAnalyzerBase {
  // Assignment 2 change (2.1): custom stopword list specified by instructions.
  static final List<String> wordList = Arrays.asList("about", "dost", "from", "hath", "his", "O", "that", "the", "thou");
  static final CharArraySet wordCharArraySet = new CharArraySet(wordList, true);
  ...
  public MyStandardAnalyzer() {
    // Assignment 2 change (2.1): use only the custom stopword list.
  ...
  protected TokenStreamComponents createComponents(final String fieldName) {
    ...
    // Assignment 2 change (2.2): apply Porter stemming during analysis.
